...
class choria (
  ...
  Variant[Enum["stderr", "stdout", "discard",], Stdlib::Absolutepath] $broker_logfile = $logfile,
  Variant[Enum["stderr", "stdout", "discard",], Stdlib::Absolutepath] $server_logfile = $logfile,
